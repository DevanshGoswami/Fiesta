    ...
    <h2 style={{fontWeight:"800",fontSize:"40px",marginBottom:"50px"}}><span style={{color:'#0f1178'}}>S</span>PONSORS</h2>
           ...
           <h2>Gold</h2>
            <div className="row justify-content-center" style={{marginTop:"50px"}}>
                ...
                <div className="col-12 col-sm-3 mx-2 py-3 mt-1" >
                    <a href="https://www.portis.io/"><img src="https://hackernoon.com/hn-images/1*HI_UYfyJSVS-MvbN7tZmxA.png" alt="" height="60px" width="150px"></img></a>  
                </div>
           ...
           <h2>Silver</h2>
            ...
            <div className="row justify-content-center" style={{marginTop:"50px"}}>
                ...
                <div className="col-12 col-sm-3 mx-2 py-3">
                <a href="https://codingblocks.com/"><img src="https://codingblocks.com/assets/images/cb/cblogo.png" height="40px" width="140px"  alt=""></img></a>
                </div>
